...
const TEMPLATES: Record<string, Solid3dTemplate> = {
  ...
  oblique_prism: {
    ...
    segments: [
      ...
      { from: p(32, 48), to: p(44, 20), hidden: true },
      { from: p(58, 48), to: p(70, 20) },
      { from: p(72, 64), to: p(84, 36) },
      { from: p(58, 74), to: p(70, 46) },
      { from: p(32, 74), to: p(44, 46) },
      { from: p(18, 64), to: p(30, 36), hidden: true },
      { from: p(44, 20), to: p(70, 20) },
      { from: p(70, 20), to: p(84, 36) },
      { from: p(84, 36), to: p(70, 46) },
      { from: p(70, 46), to: p(44, 46) },
      { from: p(44, 46), to: p(30, 36), hidden: true },
      { from: p(30, 36), to: p(44, 20), hidden: true },
    ],
  },
  triangular_prism: {
    id: "triangular_prism",
  ...
  oblique_triangular_prism: {
    ...
    segments: [
      ...
      { from: p(22, 72), to: p(40, 50) },
      { from: p(50, 74), to: p(70, 52) },
      { from: p(34, 46), to: p(54, 24) },
      { from: p(40, 50), to: p(70, 52) },
      { from: p(70, 52), to: p(54, 24) },
      { from: p(54, 24), to: p(40, 50), hidden: true },
    ],
  },
  hexagonal_prism: {
    id: "hexagonal_prism",
